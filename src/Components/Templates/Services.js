            ...
            <table style={{ width: "100%" }}>
              ...
              <tbody>
                {currentTemplates.map((template) => (
                  <tr key={template._id}>
                    <td onClick={() => handleEdit(template._id)} style={{ cursor: "pointer", color: "var( --text-color)", textAlign: "center" }}>
                      {template.serviceName}
                                     </td>
                    <td>
                      <div className="ci-menu-kebab" onClick={() => toggleMenu(template._id)} style={{ cursor: "pointer", fontSize: "20px", alignItems: "center" }}>
                        &#8942;
                      </div>
